...
public class OrderUnitTests {
    ...
    void createOrder_Success() {
        ...
        OrderCreateResponse createResponse = orderCommandService.create(orderRequest, userEmail, userRole);
    ...
    void createOrder_Fail_DB() {
        ...
        assertThatThrownBy(() -> orderCommandService.create(orderRequest, userEmail, userRole))

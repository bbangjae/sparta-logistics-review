 ...
 * 상품 응답 DTO
 * 
 * 상품 조회 시 반환하는 데이터 전송 객체입니다.
 * API 명세에 정의된 응답 형식에 맞추어 설계되었으며,
 * Entity의 내부 구현을 숨기는 역할을 합니다. (캡슐화)
 */
@Getter
@Builder
@NoArgsConstructor
...
public class ProductResponseDto {
     ...
     * 
     * Product Entity를 API 명세에 맞는 응답 형식으로 변환합니다.
     * 단일 책임 원칙(SRP)에 따라 변환 로직만 담당합니다.
     * 
     * @param product 변환할 Product Entity
     * @return 변환된 ProductResponseDto
     */

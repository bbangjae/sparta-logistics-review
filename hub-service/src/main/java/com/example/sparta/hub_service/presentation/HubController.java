package com.example.sparta.hub_service.presentation;

import com.example.sparta.hub_service.application.HubService;
import com.example.sparta.hub_service.application.command.CreateHubCommand;
import com.example.sparta.hub_service.application.command.UpdateHubCommand;
import com.example.sparta.hub_service.application.dto.HubSearchCondition;
import com.example.sparta.hub_service.presentation.request.CreateHubRequest;
import com.example.sparta.hub_service.presentation.request.UpdateHubRequest;
import com.example.sparta.hub_service.presentation.response.HubCreateResponse;
import com.example.sparta.hub_service.presentation.response.HubDetailResponse;
import com.example.sparta.hub_service.presentation.response.HubSearchResponse;
